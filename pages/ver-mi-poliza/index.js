...
function Siniestro() {
    ...
    const consultarPoliza = async () => {
        ...
        try {
            ...
            if (lista.length === 1) {
                setPropuestaSeleccionada(lista[0]);
            }
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', width: '100%' }}>
            ...
            <div className="body">
                <div className="root-error-page" style={{ marginLeft: '10px', marginRight: '10px' }}>
                                ...
                                {error && error !== 'RUT no válido' && (
                                    <div style={s.errorBanner}>
                                        ...
                                        <div style={{ flex: 1 }}>
                                            ...
                                            <p style={{ margin: '2px 0 0', fontSize: '13px', color: '#7f1d1d', lineHeight: '1.4' }}>
                                                {error}
                                            </p>
                                        </div>
                                        <button
                    ...
                    {Array.isArray(propuestas) && propuestas.length === 0 && !propuestaSeleccionada && (
                        <div style={s.sinDatosWrapper}>
                            <AlertTriangleIcon />
                            <h2 style={{ ...s.sectionTitle, textAlign: 'center', marginBottom: '4px' }}>
                                Sin póliza registrada
                            </h2>
                        ...
                        return (
                            <div style={s.resultadoWrapper}>
                                ...
                                <div style={s.resultHeader}>
                                    ...
                                    <button
                                        onClick={tieneMultiples ? volverALista : volverAlFormulario}
                ...
                {/* ── Bloque de contacto permanente ── */}
                {/*<div style={s.contactoWrapper}>
                    <p style={s.contactoTexto}>
                        Para cualquier otra consulta comunícate con nosotros al WhatsApp{' '}
                        <a href="https://wa.me/56999999999" target="_blank" rel="noreferrer" style={s.contactoLink}>
                            +569 99999999
                        </a>
                    </p>
                    <div style={s.contactoDivider} />
                    <p style={s.contactoTexto}>
                        Para modificar o dar de baja tu póliza llama al{' '}
                        <a href="tel:6003001919" style={s.contactoLink}>
                            600 300 1919
                        </a>
                    </p>
                </div>*/}
...
// ─── Card genérica de asistencia (siniestro) ─────────────────────────────────
...
// ─── Card dinámica de garantía ────────────────────────────────────────────────

function CardGarantia({ tipo, compania, telefono }) {
    const sinTelefono = !telefono;

    const config = {
        // ── Garantía Total: botón de llamada al 6003001919 ──
        total: {
            color: '#16a34a',
            ...
            accion: (
                <a href="tel:6003001919" style={{ ...s.btnCall, backgroundColor: '#16a34a' }}>
                    <PhoneIcon /> Llamar al 600 300 1919
                </a>
            ),
        },
        // ── Garantía Mecánica: botón que redirige a garantiamecanica.cl ──
        mecanica: {
            color: '#2563eb',
            ...
            accion: (
                <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    style={{ ...s.btnCall, backgroundColor: '#2563eb' }}
                >
                    <ExternalLinkIcon size={17} /> Ir a Garantía Mecánica
                </a>
            ),
        },
        // ── Sin garantía: CTA a contratar.garantiamecanica.cl ──
        sin: {
            color: '#999',
    ...
    return (
        <div style={{ ...s.card, borderTop: `4px solid ${c.color}` }}>
            ...
            {/* Coberturas (total / mecanica) o bloque sin garantía */}
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '7px' }}>
                    {c.coberturas.map((cob) => (
                        <div key={cob} style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13px', color: '#444' }}>
                            <CheckIcon color={c.color} size={18} />
                            {cob}
                        </div>
                    ))}
                </div>
            ) : (
                /* ── Sin garantía: mensaje + botón contratar ── */
                <div style={{ backgroundColor: '#fff8f0', borderRadius: '12px', padding: '16px', border: '1px dashed #FF521B', textAlign: 'center' }}>
                    ...
                    {/* <a
                        href="https://contratar.garantiamecanica.cl"
                        target="_blank"
                        rel="noreferrer"
                        style={{
                            display: 'inline-flex', alignItems: 'center', gap: '6px',
                            padding: '10px 20px', borderRadius: '10px',
                            backgroundColor: '#FF521B', color: '#fff',
                            fontWeight: '700', fontSize: '13px',
                            textDecoration: 'none',
                        }}
                    >
                        <ShieldCheckIcon color="#fff" size={15} />
                        Contratar garantía aquí
                    </a> */}
                </div>
            )}

            {/* Compañía + N° asistencia + botón de acción (solo total y mecánica) */}
            {tipo !== 'sin' && (
                <>
                    <div style={s.divider} />
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
...
const s = {
    ...
    heroTitle: {
        ...
        lineHeight: '1.25', marginBottom: '14px', letterSpacing: '-0.5px',
    },
    heroSub: {
        fontSize: '16px', color: '#666', lineHeight: '1.6',
    ...
    sinDatosWrapper: {
        ...
        backgroundColor: '#fff', borderRadius: '20px', padding: '48px 32px',
        border: '1px solid #e8e8e8', boxShadow: '0 2px 16px rgba(0,0,0,0.06)', textAlign: 'center',
    },
    tipCard: {
    ...
    card: {
        backgroundColor: '#fff', borderRadius: '16px',
        border: '1px solid #e8e8e8', padding: '22px 24px',
    ...
    footerBtn: {
        ...
        fontWeight: '700', fontSize: '14px', textDecoration: 'none', border: 'none', cursor: 'pointer',
    },
    footerHint: { fontSize: '13px', color: '#aaa' },

    // Bloque de contacto permanente (sobre CotizaAhoraConNosotros)
    contactoWrapper: {
        width: '100%',
        padding: '24px 20px',
        textAlign: 'center',
    ...
    contactoTexto: {
        fontSize: '15px', color: '#555', margin: 0, lineHeight: '1.6',
    },
    contactoLink: {
        color: '#FF521B', fontWeight: '700', textDecoration: 'none',
    },
    contactoDivider: {
        width: '40px', height: '1px', backgroundColor: '#e0e0e0',
    },

    btnOrange: {
        display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '8px',
        height: '52px', padding: '0 24px', borderRadius: '12px',
    ...
    btnCall: {
        ...
        padding: '12px', borderRadius: '10px', color: '#fff',
