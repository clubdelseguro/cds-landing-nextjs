    ...
    <div className="body">
      ...
      <div className={styles.rootNuestraHistoria}>
        ...
        <div className={styles.containerNuestraHistoria}>
          ...
          <div className={styles.descriptionNuestraHistoria}>
            {/* {data ? data?.content1 : <Code
                    ...
                    />} */}
            <span>
              Somos Corredores de Seguros regulados por la CMF y respaldados por
              las principales compañías aseguradoras del país.
            </span>
            <span>
              Como corredores de seguros, tenemos como objetivo asesorar a las
              personas que deseen asegurarse, ofreciéndoles el mejor seguro de
              acuerdo a sus requerimientos.
            </span>
            <span>
              Contamos con más de 15 años de experiencia en el sector automotriz
              y actualmente más de 20.000 clientes ya confían en nuestros
              servicios.
            </span>
          </div>
        </div>
        <div id="texto" className={styles.desarrolloNuestraHistoria}>
          ...
          <p>
            ✔ Porque contamos con la confianza y respaldo de las principales
            compañías de seguro del país.
          </p>
          <p>
            ✔ Porque nos preocupamos de que siempre tengas las mejores
            condiciones en tu Seguro Automotriz.
          </p>
          <p>
            ✔ Porque las compañías con las que trabajamos cuentan con las
            mejores asistencias del mercado para nuestros clientes y sus
            vehículos.
          </p>
          <p>
            ✔ Porque puedes contratar tu seguro en nuestro sitio web en forma
