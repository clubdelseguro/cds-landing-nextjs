            ...
            <div className={styles.elementSup}>
                <Link href="/" >
                    <div className={styles.logo}>
                        <img loading="lazy" src="/assets/Logo 2023 CDS Normal.svg" width="241px" alt="Logo CDS" />
                    </div>
                </Link>
                <div className={styles.barNavigation}>
                    <div className={styles.barNavigation2}>
                        ...
                        <div className={styles.item2} >
                            <a href="https://cotizador.clubdelseguro.cl/" target="_blank" rel="noreferrer" className={styles.link} style={{ color: '#000000' }}>
                                Cotiza Aqui
                            </a>
                        </div>
                    </div>
